...
<section id="board-write-container">
    ...
    <span onclick="location.href='${path}/board/list'" class="toPage mb-3"> 이전 페이지로 돌아가기 </span>
							</div>
							<!-- 제목-->
									...
									<div class="d-flex align-items-center mb-4 me-4">
										...
										<img class="rounded-circle"
											...
											class="fs-xs text-muted"><c:out
													value="${board.writerId}" /></span> <span
											class="fs-xs text-muted">· <fmt:formatDate type="both"
									...
									<form action="${path}/board/reply" method="post"
										...
										<div class="col-1 offset-9">
											<button id="btn-insert"
												...
												type="submit" onclick="return validateLogin()">댓글 쓰기</button>
										</div>
									</form>
								</div>
								<!-- Comment-->
										...
										<c:forEach var="reply" items="${replyList}">
											...
											<c:if test="${loginMember != null}">
												<img class="rounded-circle"
													...
													<c:if test="${loginMember == null}">
											<img class="rounded-circle"
											src="${path}/resources/img/community/avatar.jpg" width="45">
											</c:if>
												<div class="ps-3">
