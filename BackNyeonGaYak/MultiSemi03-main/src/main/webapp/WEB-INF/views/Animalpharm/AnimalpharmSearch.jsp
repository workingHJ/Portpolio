...
<jsp:include page="/WEB-INF/views/common/header.jsp">
    <jsp:param value="동물약국 검색" name="title" />
</jsp:include>

<jsp:include page="/WEB-INF/views/common/placeLeftNav.jsp"></jsp:include>
    
        <div class="col-xl-8 col-xxl-9_5 ps-4">
            <h4 class="pt-1 pt-lg-0 mt-lg-n2 ps-lg-2" style="border-bottom: solid #212121 2px; margin-bottom:10px"> 동물 약국 찾기 </h4>
            <form class="container mb-4" action="${path}/Animalpharm/AnimalpharmSearch" method="get" id="animalPharm" name="searchForm">
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="search" class="form-control" placeholder="동물약국 이름을 입력하세요" id="apname" name="apname" value="${paramMap.apname}">
            ...
            <script>
                ...
                var positions = [
                    <c:forEach var="Animalpharm" items="${list}" varStatus="status">
                        {
                            title : '${Animalpharm.apname}',
                        address : '${Animalpharm.apaddress}'
                	    }
			...
			<script>
            function addFavor(favorAnimalpharm, apno, mno) {
                var $favorAnimalpharm = $(favorAnimalpharm);
                $.ajax({
                    type: "POST",
                    url: "/semi03/Animalpharm/addFavor",
                    data: JSON.stringify({ apno: apno, mno: mno }),
                    dataType: "json",
