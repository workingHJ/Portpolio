package com.multi.semi03.member.model.service;
...
import com.multi.semi03.member.model.mapper.MemberMapper;
...
public class MemberService {
	...
	public String saveFile(MultipartFile upfile, String id, String savePath) {
		...
		String renamedFileName = id +".png";
		String renamedPath = savePath + "/" + renamedFileName;

		try {
			File file = new File(renamedPath);
			file.delete();
